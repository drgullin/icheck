...
(a.parent().html(a.attr("style",a.data(l).s||"").trigger(d||"")),a.off(".i").unwrap(),g('label[for="'+a[0].id+'"]').add(a.closest("label")).off(".i"))}function f(a,d,g){if(a.data(l))return a.data(l).o[d+(g?"":"Class")]}function q(a){return a.charAt(0).toUpperCase()+a.slice(1)}g.fn[l]=function(a,d){var h=navigator.userAgent,c=/ipad|iphone|ipod/i.test(h),b='input[type="'+A+'"], input[type="'+s+'"]';if(/^(check|uncheck|toggle|disable|enable|update|destroy)$/.test(a))return this.each(function(){var c=
g(this);(c.is(b)?c:c.find(b)).each(function(){c=g(this);"destroy"==a?G(c,"ifDestroyed"):B(c,!0,a);g.isFunction(d)&&d()})});if("object"==typeof a||!a){var e=g.extend({checkedClass:j,disabledClass:n,labelHover:!0},a),f=e.handle,r=e.hoverClass||"hover",q=e.focusClass||"focus",u=e.activeClass||"active",H=!!e.labelHover,E=e.labelHoverClass||"hover",z=(""+e.increaseArea).replace("%","")|0;if(f==A||f==s)b='input[type="'+f+'"]';-50>z&&(z=-50);return this.each(function(){var a=g(this);(a.is(b)?a:a.find(b)).each(function(){a=
g(this);G(a);var d=this,b=d.id,f=-z+"%",v=100+2*z+"%",v={position:"absolute",top:f,left:f,display:"block",width:v,height:v,margin:0,padding:0,background:"#fff",border:0,opacity:0},f=c||/android|blackberry|windows phone|opera mini/i.test(h)?{position:"absolute",visibility:"hidden"}:z?v:{position:"absolute",opacity:0},D=d[k]==A?e.checkboxClass||"i"+A:e.radioClass||"i"+s,C=g('label[for="'+b+'"]').add(a.closest("label")),m=a.wrap('<div class="'+D+'"/>').trigger("ifCreated").parent().append(e.insert),
v=g('<ins class="'+l+'-helper"/>').css(v).appendTo(m);a.data(l,{o:e,s:a.attr("style")}).css(f);e.inheritClass&&m[p](d.className||"");e.inheritID&&b&&m.attr("id",l+"-"+b);"static"==m.css("position")&&m.css("position","relative");B(a,!0,"update");if(C.length)C.on(w+".i mouseover.i mouseout.i "+F,function(b){var e=b[k],f=g(this);if(!d[n])if(e==w?B(a,!1,!0):H&&(/ut|nd/.test(e)?(m[t](r),f[t](E)):(m[p](r),f[p](E))),c)b.stopPropagation();else return!1});a.on(w+".i focus.i blur.i keyup.i keydown.i keypress.i",
